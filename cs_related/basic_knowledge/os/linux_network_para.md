...
## TCP/IP 内核参数调整和观测的具体方法
通过以下方法可以将/etc/sysctl.conf中设置的具体参数生效
```
/sbin/sysctl –p
```
通过以下文件可以观测当前运行中的各个参数的具体值
...
net.ipv4.tcp_max_tw_buckets = 10000         #也可以改为更大，比如40000
   ...
   1029 TIME_WAIT
    153 ESTABLISHED
     ...
     11 LISTEN
      ...
      1 14638
      1 14621
net.ipv4.tcp_fin_timeout = 10      #测试过改为15
